<h1 align="center">Hi 👋, I'm Benny Tordrup</h1>
...
1. ⭐ Starred [microsoftgraph/msgraph-snippets-dotnet](https://github.com/microsoftgraph/msgraph-snippets-dotnet)
2. ⭐ Starred [devexlead/onboarding-winget](https://github.com/devexlead/onboarding-winget)
3. 🆕 Opened an issue [#44404](https://github.com/dotnet/docs/issues/44404) in [dotnet/docs](https://github.com/dotnet/docs)
4. 🗣 Commented on issue [#436](https://github.com/serilog/serilog-settings-configuration/issues/436) in [serilog/serilog-settings-configuration](https://github.com/serilog/serilog-settings-configuration): [View Comment](https://github.com/serilog/serilog-settings-configuration/issues/436#issuecomment-2594659988)
5. ❌ Closed an issue [#436](https://github.com/serilog/serilog-settings-configuration/issues/436) in [serilog/serilog-settings-configuration](https://github.com/serilog/serilog-settings-configuration)
6. 🗣 Commented on issue [#436](https://github.com/serilog/serilog-settings-configuration/issues/436) in [serilog/serilog-settings-configuration](https://github.com/serilog/serilog-settings-configuration): [View Comment](https://github.com/serilog/serilog-settings-configuration/issues/436#issuecomment-2594659080)
7. ⭐ Starred [microsoft/wslg](https://github.com/microsoft/wslg)
8. ⭐ Starred [microsoft/wil](https://github.com/microsoft/wil)
9. ⭐ Starred [microsoft/VS-PPT](https://github.com/microsoft/VS-PPT)
10. ⭐ Starred [microsoft/sarif-visualstudio-extension](https://github.com/microsoft/sarif-visualstudio-extension)
